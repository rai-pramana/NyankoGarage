...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.logout = function (req, dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.logout(req.user.id, dto.refreshToken)];
                        case 1:
                            _a.sent();
        ...
        AuthController_1.prototype.changePassword = function (req, dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.changePassword(req.user.id, dto)];
                        case 1:
                            _a.sent();
    ...
    (function () {
        ...
        _me_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Post)('me'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
        _updateProfile_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Patch)('profile')];
        _changePassword_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Post)('change-password'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
