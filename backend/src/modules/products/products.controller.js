...
var ProductsController = function () {
    var _classDecorators = [(0, common_1.Controller)('products'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard)];
    ...
    var ProductsController = _classThis = /** @class */ (function () {
        ...
        ProductsController_1.prototype.create = function (createProductDto, req) {
            return this.productsService.create(createProductDto, req.user.id);
        };
        ProductsController_1.prototype.findAll = function (query) {
            return this.productsService.findAll(query);
        };
        ProductsController_1.prototype.getCategories = function () {
    ...
    (function () {
        ...
        _create_decorators = [(0, common_1.Post)(), (0, roles_guard_1.Roles)(client_1.UserRole.OWNER, client_1.UserRole.ADMIN)];
        _findAll_decorators = [(0, common_1.Get)()];
        _getCategories_decorators = [(0, common_1.Get)('categories')];
        _findOne_decorators = [(0, common_1.Get)(':id')];
        _update_decorators = [(0, common_1.Patch)(':id'), (0, roles_guard_1.Roles)(client_1.UserRole.OWNER, client_1.UserRole.ADMIN)];
        _remove_decorators = [(0, common_1.Delete)(':id'), (0, roles_guard_1.Roles)(client_1.UserRole.OWNER, client_1.UserRole.ADMIN)];
