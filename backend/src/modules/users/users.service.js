    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.findAll = function (query) {
            return __awaiter(this, void 0, void 0, function () {
                var search, role, _a, page, _b, limit, skip, where, _c, users, total;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            search = query.search, role = query.role, _a = query.page, page = _a === void 0 ? 1 : _a, _b = query.limit, limit = _b === void 0 ? 20 : _b;
                            skip = (page - 1) * limit;
                            where = {};
                            if (search) {
                                where.OR = [
        ...
        UsersService_1.prototype.update = function (id, dto, requesterId) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        UsersService_1.prototype.deactivate = function (id, requesterId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (id === requesterId) {
        ...
        UsersService_1.prototype.reactivate = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.user.update({
                            where: { id: id },
